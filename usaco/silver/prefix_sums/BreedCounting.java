...
/**
Source: USACO
Problem url: https://usaco.org/index.php?page=viewproblem2&cpid=572
*/
import java.io.*;
import java.util.*;
...
public class BreedCounting {
    public static void solve(FastScanner io) throws Exception {
        ...
        for (int i = 1; i <= Q; i++) {
            ...
            int H = pref[b][1] - pref[a-1][1];
            int G = pref[b][2] - pref[a-1][2];
            int J = pref[b][3] - pref[a-1][3];
            io.println(H + " " + G + " " + J);
        }
    }
    ...
    */
    public static void main(String[] args) throws Exception {
        FastScanner io = new FastScanner("bcount"); // usaco
